...
export default function Bills() {
  ...
  const confirmDelete = async () => {
    ...
    try {
      await billsService.remove(toDelete);
      ...
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            All your bills and lot deliveries.
          </p>
        </div>
      ...
      <div className="rounded-2xl border border-border bg-card p-3 lg:p-4 shadow-card flex flex-wrap gap-2">
        <div className="relative flex-1 min-w-[200px]">
          ...
          <Input
            ...
            placeholder="Search bill #, lot, customer..."
        ...
        >
          <SelectTrigger className="w-[160px] h-10 border-0 bg-secondary">
                ...
                >
                  ...
                  <td
                    className={`px-5 py-3 text-right font-display font-semibold ${
                      b.balanceAmount > 0 ? "text-destructive" : "text-success"
                    }`}
                  >
        ...
        {data && data.total > limit && (
          <div className="flex items-center justify-between px-5 py-3 border-t border-border">
            ...
            <div className="flex gap-1">
              ...
              <div className="grid h-8 min-w-8 place-items-center rounded-md border border-border px-2 text-xs">
                {page} / {totalPages}
              </div>
